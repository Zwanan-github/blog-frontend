    ...
    <div>
        <v-form>
            <v-container>
                ...
                <v-row dense>
                    <v-col cols="6">
                        <v-text-field v-model="draft.name" label="文章标题"></v-text-field>
                    </v-col>
                    <v-col cols="6">
        ...
        <MdEditor class="mt-16" editor-id="edit" v-model="draft.content" @onUploadImg="onUploadImg" @onError="catchEditorError"
